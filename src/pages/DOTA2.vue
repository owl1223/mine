<template>
  <div>
    <div class="kong"></div>
    <div class="allleft">DOTA2</div>
    <div class="cont">
      <div class="roomlink" v-for="img in arr">
        <div class="lost">
          <div class="roompic">
            <img :src="img.room_src">
          </div>
          <div class="popinf">
            <i class="user"></i>
            <span class="popname">
          ...
          <div class="fire">
            <i class="fireicon"></i>
            <span class="firestr"> {{ img.hn | HN}} </span>
          </div>
        </div>
        <div class="info"> {{ img.room_name }}</div>
      </div>
    </div>
  </div>
</template>
...
<script>
  import DOTA2 from '../assets/DOTA2'
